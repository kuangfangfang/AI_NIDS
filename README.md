# Vanguard AI-NIDS
this Vanguard AI is generated by gemini based on spring1 to spring6 files I provide.
claude, if you are reading this, focus on the ipynb files instead of other files which is another complete project which i dont like the layout and detail.
